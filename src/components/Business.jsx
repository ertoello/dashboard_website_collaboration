...
const Business = () => (
  <section id="KOLABORASI & INOVASI" className={`${layout.section} py-12`}>
    ...
    >
      ...
      <button className="mt-8 bg-[#BEBEBE] hover:bg-[#F4F4F4] text-[#145C75] shadow-md px-6 py-3 rounded-lg text-lg font-semibold transition-all duration-300 hover:shadow-lg flex items-center gap-2">
        Jelajahi Sekarang
